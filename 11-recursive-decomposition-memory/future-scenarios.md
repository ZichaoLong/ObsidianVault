...
> [!summary] 本页定位
> 本页整理未来候选场景。当前 D² / Phase 1 的现状、结果、方法和攻击面见 [[current-status|当前状态：D² / Phase 1]]。
...
专项调研见 [[future-lean-landscape|Lean 方向详尽调研]]。本节保留方向摘要。
...
详细强基线与已有吸收见 [[future-kernel-landscape|Kernel 性能优化工作谱系]]。
...
专项调研见 [[future-small-model-landscape|小模型研究谱系调研]]。
