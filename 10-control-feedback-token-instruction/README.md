...
- 会不会被 Agent+Tools / retrieval / scaffold 吸收：[[10-control-feedback-token-instruction/theory-and-challenges#主要攻击面|主要攻击面]]，证据表见 [[10-control-feedback-token-instruction/reference-agent-tools-absorption|Agent 工程对 A 弱版本的吸收]]
