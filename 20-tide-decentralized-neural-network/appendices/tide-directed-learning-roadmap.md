...
> 本页中的课程、月份和项目只构成个人学习验收脚手架，不表示 Tide 已经实现这些项目，也不构成研究里程碑、正式定义、定理或架构承诺。任何 Tide 主张都必须回到八份核心职责文档或原始来源核验。返回 [[20-tide-decentralized-neural-network/README|Tide 主入口]]。
