...
ReceiverCell Propagation / State Replay Test
...
- 同拓扑 selected-dispatch/BO `ReceiverCell`、`ReceiverState`/`SelectorState`、五类 route artifact、state knockout 与 save/reload replay。
...
Checkpoint growth shared foundation：
