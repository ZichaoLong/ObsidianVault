...
- 中英文术语统一参见 [[token-owned-general-dag-routing#术语约定与中英文对照|术语约定与中英文对照]]；正文原则上使用中文，英文只保留在术语对照、公式、接口、固定缩写和模型专名中。
- 外部谱系负责回答“是什么、解决什么、不解决什么、在 Tide 中对应什么”；正式结论仍落在转移、有向无环图、商、模拟与折叠上。
