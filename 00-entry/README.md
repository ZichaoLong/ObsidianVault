...
| 方向 | 一等公民 | 核心问题 |
| --- | --- | --- |
| 控制反馈 | 状态 + 指令集 | 在某个决策状态下，系统能看什么、改什么、验证什么、提交什么、回滚什么 |
...
- TIDE：[[20-tide-decentralized-neural-network/README|数学教材与语义总览]]；[[20-tide-decentralized-neural-network/settlegraph-learning-note|SettleGraph 入门教材]]
